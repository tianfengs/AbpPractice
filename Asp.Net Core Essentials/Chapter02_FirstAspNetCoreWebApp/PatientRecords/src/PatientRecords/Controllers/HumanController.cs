...
namespace PatientRecords.Controllers
{
    public class HumanController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DateOfBirth,Name,SocialSecurityNumber")] Human human)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateOfBirth,Name,SocialSecurityNumber")] Human human)
        {
            if (id != human.Id)
            {
                return NotFound();
