...
namespace ABPMVCTest.Tests
{
    public abstract class ABPMVCTestTestBase : AbpIntegratedTestBase
    {
        protected ABPMVCTestTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<ABPMVCTestApplicationModule>();
            modules.Add<ABPMVCTestDataModule>();
        }

        public void UsingDbContext(Action<ABPMVCTestDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<ABPMVCTestDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<ABPMVCTestDbContext, T> func)
        {
            T result;
